...
public class Student {
    ...
    public void enrollIn(Course c) {
        if (c == null) return;
        RegistrarMediator.getInstance().enrollStudentInCourse(this, c);
    }

    public void waitlistFor(Course c) {
        if (c == null) return;
        RegistrarMediator.getInstance().waitlistStudentForCourse(this, c);
    }

    public void dropCourse(Course c) {
        if (c == null) return;
        RegistrarMediator.getInstance().dropStudentFromCourse(this, c);
    }
